/*jshint browser: true, node: true, regexp: false, nomen: false, indent: 4*/
(function () {
    'use strict';
    ...
    Walt_JavaScript.prototype.init = function (options, callback) {
        ...
        if (!options.method || _.find(['uglifyjs', 'closure'], function (method) {
            return options.method === method;
        }) === undefined) {
            callback('"method" must either be "uglifyjs" or "closure". Verify walt.json.');
        } else {
            callback();
        }
    };
    ...
    Walt_JavaScript.prototype.onFile = function (data, callback) {
        ...
        case 'uglifyjs':
            this.uglifyjs(data, function (result) {
                callback({
    ...
    /**
     * Apply UglifyJS on JavaScript file.
     *
     * @private
     */
    Walt_JavaScript.prototype.uglifyjs = function (data, callback) {
        var uglify = require('uglify-js');
        callback(uglify(data, {}));
    };
